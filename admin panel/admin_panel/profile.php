...
$ulogin=$_SESSION['username'];
  ...
  $login=mysqli_query($conn,  "SELECT * FROM admin_user WHERE email = '$ulogin'");
...
if(isset($_POST['update']))
{
  ...
  if((!empty($fname)) && (!empty($lname)) && (!empty($mobileno)) )
 {
  ...
  $update=mysqli_query($conn,"update admin_user set firstname='$fname' , lastname='$lname' ,mobileno='$mobileno' where email='$ulogin'");
  echo '<script> 
